...
**Принцип:** общая структура — в базе; per-aggregate variation — в наследниках с переопределённым default-ом ключевого поля. Группа собирает все per-aggregate блоки.
